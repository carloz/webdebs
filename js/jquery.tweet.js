  ...
  $.fn.tweet = function(o){
    ...
    function relative_time(time_value) {
      ...
      var pluralize = function (singular, n) {
        var str = singular;
        if(n>1) {
            switch(singular[singular.length-1]) {
                case 'a':
                    str = singular.substr(0,singular.length-1) + 'e';
                    break;
                case 'o':
                    str = singular.substr(0,singular.length-1) + 'i';
                    break;
            }
        }
        return n + ' ' + str;
      ...
      return 'circa ' + pluralize("ora", parseInt(delta / 3600)) + ' fa';
      } else {
      return 'circa ' + pluralize("giorno", parseInt(delta / 86400)) + ' fa';
      }
    }
